...
while True:
    ...
    #Because this sensor is under the ds18b20 sensor and is not taken by the light.
    ...
    val = (now.strftime('%Y-%m-%d %H:%M-%S'), round(temperature_in_celsius,2), pressure, humidity, round(altitude,2), round(wind,2), rainfall)
